...
class _Dnd5eSheetState extends State<Dnd5eSheet> {
  ...
  Widget build(BuildContext context) {
    Widget badge(String label, String value) => Container(
            ...
            children: [
              ...
              Wrap(
                children: [
                  badge('AC', '$_ac'),
                  badge('Prof', '+$_prof'),
                  badge('Passive Perception', '$_passive'),
                ],
              ),
              ...
              Wrap(
                children: [
                  badge('STR', '${_mods['STR'] ?? 0}'),
                  badge('DEX', '${_mods['DEX'] ?? 0}'),
                  badge('CON', '${_mods['CON'] ?? 0}'),
                  badge('INT', '${_mods['INT'] ?? 0}'),
                  badge('WIS', '${_mods['WIS'] ?? 0}'),
                  badge('CHA', '${_mods['CHA'] ?? 0}'),
                ],
              ),
