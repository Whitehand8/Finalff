      ...
      case 'ability':
        {
          ...
          final detail =
              'Ability d20${adv == null ? '' : '($adv)'}: ${r.detail} + mod($mod) + prof($profBonus) = $total${dc == null ? '' : ' vs DC $dc'}';
      ...
      case 'skill':
        {
          ...
          final success = dc == null ? true : total >= dc;
          final detail =
              'd20${adv == null ? '' : '($adv)'}: ${r.detail} + mod($mod) + prof($profBonus) = $total${dc == null ? '' : ' vs DC $dc'}';
          return RollResult(detail: detail, total: total, success: success);
        }
      case 'save':
        {
          ...
          final success = dc == null ? true : total >= dc;
          final detail =
              'Save d20${adv == null ? '' : '($adv)'}: ${r.detail} + mod($mod) + prof($profBonus) = $total${dc == null ? '' : ' vs DC $dc'}';
          return RollResult(detail: detail, total: total, success: success);
        }
      case 'attack':
        {
      ...
      default:
        {
          ...
          final success = dc == null ? true : total >= dc;
          final detail =
              'd20${adv == null ? '' : '($adv)'}: ${r.detail} + $baseMod = $total${dc == null ? '' : ' vs DC $dc'}';
          return RollResult(detail: detail, total: total, success: success);
        }
    }
  }
